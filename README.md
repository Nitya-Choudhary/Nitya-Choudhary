...
<!--
**Nitya-Choudhary/Nitya-Choudhary** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
# 💫 About Me:
About Me 🌟<br>🎓 Second-year BTech IT student @ IGDTUW (GPA: 8.6)<br>🤖 AI/ML & NLP enthusiast | Data whisperer | Code alchemist<br>🏆 Hackathon lover | Research awardee | Team leader<br><br>🔥 Currently Obsessing Over<br>🤖 AI/ML Frontiers:<br>Fine-tuning LLMs (Llama, BERT) for niche domains like spiritual texts & nutrition.<br>Edge-case hunting in computer vision (OpenCV + TensorFlow).<br><br>📊 Data Alchemy:<br>Building fault-tolerant trading models (Python + Alpaca API).<br>Scraping, wrangling, and visualizing chaotic real-world datasets.<br><br>☁️ Cloud & DevOps:<br>Serverless AI pipelines on AWS (Lambda, Sagemaker).<br>CI/CD for ML models → because "it works locally" isn’t enough.<br><br>🛠️ Tool Tinkering:<br>Jupyter Notebook → VS Code → Git → "Why did this work now?"<br>Linux shell scripting (for that hacker-movie vibe)<br><br>💡 I believe in:<br>"Code, fail, debug, repeat" 🔄<br>Open-source karma 🌍💛<br>Coffee-fueled midnight debug sessions ☕🐛<br><br>⚡ Fun fact: I can recite Python syntax faster than the alphabet. 🐍<br><br>📫 Let’s geek out! DM me about:<br>Hackathons 🚀<br>Research collabs 🔬<br>Why The Matrix is a documentary 


## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/nityachoudhary_29) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/https://www.linkedin.com/in/nitya-choudhary-34b330321/) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/nitya_punia29) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:nityapunia141@gmail.com) 
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=Nitya-Choudhary&theme=radical&hide_border=false&include_all_commits=true&count_private=true)<br/>
